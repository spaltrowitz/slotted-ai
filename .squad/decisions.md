...
## Architecture Decision: Two-Way Calendar Sync (Beard, 2026-02-28)
...
## Edge Cases Affecting Two-Way Sync Architecture (Nate, 2026-02-27)

**From:** Nate (QA)  
**To:** Beard (Architect), Shari  
**Date:** 2025-02-27  
...
**Need from Beard:** Define thresholds and the flow. My tests will assert against whatever is decided.
...
## Decision: Empty State Strategy (Keeley, 2025-01-27)
