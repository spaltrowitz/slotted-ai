...
export default function LoginPage() {
  ...
  const handleContinueWithGoogle = async () => {
    ...
    sessionStorage.setItem('slotted_post_auth_redirect', '/dashboard');
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-page-warm">
      ...
      <div className="absolute -bottom-20 right-1/4 h-[400px] w-[400px] rounded-full bg-gradient-to-tl from-cyan-200/30 via-sky-100/20 to-transparent blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 pt-6 sm:pt-16 pb-6 sm:pb-10 text-center">
        ...
        <div className="mt-5 sm:mt-8 flex flex-col items-center gap-3">
          ...
          <p className="max-w-xs text-xs leading-relaxed text-gray-500">
            New to Slotted? We'll create your account automatically.
          </p>
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 pb-6 sm:pb-10">
        ...
        <div className="grid grid-cols-3 gap-2 sm:hidden">
          {[
            ...
            { step: '2', title: 'Invite friends', color: 'from-cyan-50 to-sky-50', border: 'border-sky-100' },
