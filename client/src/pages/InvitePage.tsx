        ...
        {error ? (
          ...
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            {inviter.photoUrl ? (
              ...
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-slotted-400 to-sky-500 text-xl font-bold text-white ring-4 ring-slotted-100 shadow-md">
