              ...
              <div className="rounded-2xl border border-gray-200/60 bg-white p-3 sm:p-4 shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {[
                    ...
                    <button key={opt.value} onClick={() => setSocialRecharge(opt.value)} className={`rounded-xl border px-2 py-2 text-center transition-all ${socialRecharge === opt.value ? 'border-slotted-400 bg-gradient-to-r from-slotted-50 to-sky-50 shadow-sm' : 'border-gray-200 hover:border-slotted-200 hover:bg-gray-50'}`}>
