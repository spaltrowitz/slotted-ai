...
export default function EventInviteLandingPage() {
  ...
  if (error || (!invite && !scheduleId)) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-50 via-white to-amber-50 p-6">
  ...
  if (phase === 'vote' && schedule) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-amber-50 px-4 py-6">
            ...
            <div className="mx-auto flex max-w-md items-center justify-between gap-3">
              ...
              <button
                ...
                className={`min-h-[44px] rounded-xl px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all disabled:cursor-not-allowed disabled:opacity-50 ${
                  allResponsesIn ? 'bg-gradient-to-r from-emerald-500 to-teal-500' : 'bg-gradient-to-r from-sky-500 to-blue-500'
                }`}
              >
                {pendingRemoval
                  ? 'Undo or wait…'
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-sky-50 via-white to-amber-50">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6 py-12">
          <div className="w-full rounded-2xl bg-white p-8 shadow-xl text-center space-y-5">
            ...
            <div className="rounded-xl bg-sky-50 border border-sky-100 p-4 text-left space-y-2">
              <p className="text-xs font-medium text-sky-800">What we check:</p>
            ...
            <button
              ...
              className="w-full rounded-xl bg-gradient-to-r from-sky-500 to-blue-500 px-4 py-3.5 text-sm font-semibold text-white shadow-md transition-all hover:shadow-lg hover:-translate-y-0.5"
            >
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-sky-50 via-white to-amber-50">
      ...
      <nav className="relative z-10 flex items-center justify-center px-6 py-5">
        <Link to="/" className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-r from-sky-500 to-blue-500 text-sm font-bold text-white shadow-md">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100dvh-80px)] max-w-md flex-col items-center justify-center px-6 pb-12">
        <div className="w-full space-y-5">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-xl space-y-4">
            ...
            {/* Social proof */}
            {othersText && (
              <div className="flex items-center gap-2 rounded-xl bg-sky-50/60 border border-sky-100/50 px-4 py-3">
                <span className="text-sm">👥</span>
            ...
            <button
              ...
              className="w-full rounded-xl bg-gradient-to-r from-sky-500 to-blue-500 px-4 py-4 text-base font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
            >
              Join & Pick a Time
            </button>
