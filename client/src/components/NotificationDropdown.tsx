                              ...
                              return (
                                ...
                                >
                                  {sharedEvent.imageUrl ? (
                                    ...
                                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded bg-gradient-to-br from-sky-100 to-pink-100 text-sm"></div>
                                  )}
                                  <div className="flex-1 min-w-0">
                            ...
                            <>
                              <div className="flex gap-1.5">
                                <button
                                  ...
                                  className="rounded-lg bg-sky-500 px-3 py-2 min-h-[44px] text-xs font-semibold text-white hover:bg-sky-600 shadow-sm disabled:opacity-50"
                                >
