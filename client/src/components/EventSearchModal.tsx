            ...
            {timeframeMode === 'specific' ? (
              <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {dateWindows.map((window, index) => (
                      <button
                        ...
                        className="min-h-[36px] rounded-full bg-violet-50 px-3 text-xs font-semibold text-violet-700 ring-1 ring-violet-200"
                      >
                ...
                <label className="block">
                  ...
                  <input
                    ...
                    className="min-h-[44px] w-full rounded-xl border border-gray-200 bg-gray-50 px-3 text-sm text-gray-900 focus:border-violet-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-violet-100"
                  />
                </label>
                <label className="block">
                ...
                <button
                  ...
                  className="min-h-[44px] w-full rounded-xl bg-violet-50 px-3 py-2 text-sm font-semibold text-violet-700 ring-1 ring-violet-200 transition-colors hover:bg-violet-100"
                >
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-3">
                ...
                <button
                  ...
                  className="mt-2 min-h-[44px] w-full rounded-xl bg-white px-3 py-2 text-sm font-semibold text-violet-700 ring-1 ring-violet-200 transition-colors hover:bg-violet-50"
                >
                  Add specific dates
                </button>
              </div>
          ...
          {mode === 'browse' && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="min-h-[44px] w-full rounded-xl bg-violet-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-violet-700 disabled:opacity-50"
              >
                ...
                <div className="max-h-64 space-y-2 overflow-y-auto">
                  {browseResults.map((event) => (
                    <button
                      ...
                      className="flex min-h-[56px] w-full items-center gap-3 rounded-xl border border-gray-200 bg-white p-2.5 text-left transition-all hover:border-violet-200 hover:bg-violet-50/40"
                    >
                      {event.imageUrl ? (
