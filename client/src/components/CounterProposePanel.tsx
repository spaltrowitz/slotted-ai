            ...
            {suggestions.slice(0, 5).map((slot) => (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 px-3 py-2 min-h-[44px] text-xs font-semibold text-white shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 disabled:opacity-50"
                >
