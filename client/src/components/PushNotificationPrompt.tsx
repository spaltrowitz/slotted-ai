...
export default function PushNotificationPrompt({ mobileOnly = false }: { mobileOnly?: boolean }) {
  ...
  return (
    <div className="rounded-2xl border border-slotted-200 bg-gradient-to-r from-slotted-50 to-sky-50 p-5 shadow-sm">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            disabled={loading}
            className="mt-3 rounded-xl bg-gradient-to-r from-slotted-500 to-sky-500 px-5 py-2 text-sm font-semibold text-white shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
          >
