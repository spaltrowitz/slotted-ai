  ...
  return (
    <div className="flex min-h-screen flex-col bg-page-warm font-sans">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 h-[350px] w-[350px] rounded-full bg-gradient-to-tl from-cyan-100/20 via-sky-50/15 to-transparent blur-3xl" />
      </div>
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <Link to="/" className="font-display text-lg font-bold text-gray-900">Slotted.ai</Link>
            </div>
