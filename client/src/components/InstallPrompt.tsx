...
export default function InstallPrompt({ alwaysShow = false, desktopOnly = false }: { alwaysShow?: boolean; desktopOnly?: boolean }) {
  ...
  return (
    <>
      {/* Install banner */}
      {!showInstructions && (
        <div className="mb-4 rounded-2xl border border-slotted-200 bg-gradient-to-r from-slotted-50 to-indigo-50 p-4 shadow-sm animate-in fade-in slide-in-from-top-2">
                  ...
                  <Step
                    ...
                    description={
                      <>
                        ...
                        <span className="inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 text-xs font-medium">⊕</span>{' '}
